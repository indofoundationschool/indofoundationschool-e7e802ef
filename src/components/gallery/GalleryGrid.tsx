...
const GalleryGrid = ({
  ...
  return <>
      {images.length === 0 ? <div className="text-center py-16">
        ...
        y: -5
      }} className="rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer bg-white" onClick={() => setSelectedImage(image)}>
